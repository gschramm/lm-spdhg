...
if  beta== 0:
  fig3, ax3 = plt.subplots(4,len(gammas) + 1, figsize = (len(gammas)*2,8), squeeze = False)
else:
  fig3, ax3 = plt.subplots(2,len(gammas) + 1, figsize = (len(gammas)*2,4), squeeze = False)
...
if  beta== 0:
  fig4, ax4 = plt.subplots(4,len(gammas) + 1, figsize = (len(gammas)*2,8), squeeze = False)
else:
  fig4, ax4 = plt.subplots(2,len(gammas) + 1, figsize = (len(gammas)*2,4), squeeze = False)
