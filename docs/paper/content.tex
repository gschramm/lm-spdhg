...
\footnote{\added{the event count $\mu_e$ represents the number of times the event $e$ 
...
\added{All reconstruction algorithms used in this work were implemented in python3 the using the 
