...
is needed.
Calculating and storing this (sensitivity) image once is beneficial since it
...
the sensitivity image has to be calculated anyway and can be re-used.
...
for TOF PET scanner with 400\,ps TOF resolution and 25\,cm axial field of view,
a forward and back projection is faster in listmode if less than XXX events have to be processed.
A detailed comparison of the required memory for SPDHG and LM-SPDHG for different typical
acquisitions are listed in Table XXX.
