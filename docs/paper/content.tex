...
($x^0 = 0$ and $y^0 = 0$) and warm start as described above.
It can be seen that after 8 iterations the the relative cost of SPDHG using the warm start is lower
and decreases faster.
