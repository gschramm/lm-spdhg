...
% mem req of LM OSEM: 
% - images: x, sens
% - lists:  event list, ratio list (float)
%
% mem req of PDHG denoiser:
% - images: x, xbar, grad, dual of grad
%
% sequential alg, tmp data of LM-OSEM and PDHG denoiser dont need to be there at the same time
...
EM-TV    & event list, 1 float list &  XX\,GB  &   XX\,GB   &   X\,GB
\end{tabular}
\end{center}
