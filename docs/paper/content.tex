...
a forward and back projection is faster in listmode if approximately less than XXX events 
...
\caption{Estimation of required memory for SPDHG and LM-SPDHG assuming an image size of (300,300,125)
         ...
         to a high count 20\,min static FDG brain scan, 7e7 counts to an 80\,s static FDG body bed 
         position, and 1e7 counts to a short early dynamic frame.}
\label{tab:mem}
\end{table}
