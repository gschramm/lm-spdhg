...
\begin{figure}
  \centering
    \includegraphics[width=1.0\columnwidth]{./figure1_sparsity.png}
...
\begin{figure}
  \centering
    \includegraphics[width=1.0\columnwidth]{./figure2_SPDHG_init_3.0E+05_224_3.0E-02_3.0E+00.png}
...
This also holds for different count levels and for the structural DTV prior
as shown in subfigures (b) and (c) and for different levels of regularization.
%as shown %in supplementary Figs.~1 and 2.
...
The authors would like to thank Claire Delplancke for the insightful discussion on the
