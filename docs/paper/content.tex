...
based on the brainweb phantom [XXX] and used to generate simulated 2D TOF data including the effects
limited spatial resolution, attenuation and a flat contamination mimicking 
...
\end{equation}
%
where $\|K x \|_{2,1}$ is sum over all entries of the pointwise Euclidean norm of $K x$.
...
\subsection*{SPDHG with warm start}
...
\subsection*{Convergence of LM-SPDHG}
