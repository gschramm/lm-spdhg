...
sparse TOF PET listmode data which we finally facilitate future research on the use of
...
we simulated and reconstructed data based on the 3D XCAT [XXX] phantom and a state-of-the-art
...
Simulated listmode data was reconstructed using LM-SPDHG with 100 iterations and 224 subsets. 
...
that practical convergence is reached after approximately 20-25 iterations with 224 subsets.
