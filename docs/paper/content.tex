...
SPDHG    & event list, 1 uint, 3 float lists &  12.0\,GB  &   1.7\,GB   &   0.3\,GB \\ \hline
         & 9 images              &   0.45\,GB  &   0.45\,GB   &   0.45\,GB \\
EM-TV    & event list, 2 float list &  9.0\,GB  &   1.3\,GB   &   0.2\,GB
\end{tabular}
\end{center}
...
All reconstruction algorithms used in the work were implemented in python3 the using the open-source
