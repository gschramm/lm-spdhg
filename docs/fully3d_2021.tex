...
%Directional TV \citep{Bredies2010}ite{Ehrhardt2016}
...
In this work, we focus on the time-of-flight (TOF) PET reconstruction 
...
\begin{figure*}
  \centering
  %\includegraphics[width=1.0\textwidth]{./figs/brain2d_counts_1_0E+05_beta_6_0E-01_niter_5000_50_nsub_112_early_10.png}
...
after 10 iterations are shown. Also, it can be observed both figures that, with increasing values of $\gamma$, SPDHG-S performs increasingly similar to SPDHG in terms of PSNR and the relative cost.
...
Careful choice of the step size ratio parameter $\gamma$ depending the magnitude
if the image to be reconstructed is crucial to obtain fast convergence.
